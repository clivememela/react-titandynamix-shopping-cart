# Demo React Redux Shopping Website

1. Create online shopping website
    1. Create React App

2. menu items (home, about, contact)
Home: Amazon or flipchart examples
Navigation: adding items to cart
Contact: Basic info
Cart: proceed to buy

3. Use REACT redux structure
Use json dummy data
